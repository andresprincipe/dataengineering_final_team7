...
def get_enforcement_summary(
	county: Optional[str] = Query(default=None, description="County name (case-insensitive)"),
	year: Optional[int] = Query(default=None, ge=1900, le=2100),
	source: Optional[str] = Query(default=None, description="Data source filter, e.g., 'Air' or 'WSA'"),
