...
def _load_to_db_callable(**context):
	"""
	Placeholder loader. If ENV DB_LOAD_SCRIPT is set, this will execute it.
	Else, it will simply log a message. Adjust to your team's load script.
	"""
...
with DAG(
	...
	schedule_interval=None,  # trigger manually or set a cron like "0 6 * * *"
	catchup=False,
) as dag:
